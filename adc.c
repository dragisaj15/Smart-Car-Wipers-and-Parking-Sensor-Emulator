...
ADCON2bits.VCFG=7;
ADCON2bits.CSCNA=1;
ADCON2bits.SMPI=4;  //N=broj konverzija - 1, imamo pet konverzija => N=4
ADCON2bits.BUFM=0;
ADCON2bits.ALTS=0;
...
ADPCFGbits.PCFG10=0; //PIN ZA LM35 je analogni i ulazni
TRISBbits.TRISB10=1;

ADPCFGbits.PCFG8=0;//Touch screen 
TRISBbits.TRISB8=1;
ADPCFGbits.PCFG9=0; 
TRISBbits.TRISB9=1;

ADPCFGbits.PCFG11=0;//PIR 
TRISBbits.TRISB11=1;
...
//ADCSSL=0b0001111111111111;
  ADCSSL=0b0001111100000000; //pinovi 8 i 9 se koriste za tac, 10 za LM35, 11 za PIR, 12 za fotootpornik
ADCON1bits.ASAM=1;
